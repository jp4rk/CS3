...
/**
 * Resizes the list to twice the occupied number of elements.
 * Elements are copied over.
 *
 * @param list a pointer to a list that is to be resized
 * @return a list with twice the number of elements
 */
