...
typedef struct force_args force_args_t;

typedef struct collision_args collision_args_t;
 ...
 * registered with create_collision().
 *
 * This function performs a physics collision, but removes the second body
 *
 * @param scene the scene containing the bodies
 * @param elasticity the "coefficient of restitution" of the collision;
 * 0 is a perfectly inelastic collision and 1 is a perfectly elastic collision
 ...
 * @param body2 the second body
 */
void create_physics_destructive_collision(
    scene_t *scene,
    double elasticity,
    body_t *body1,
    body_t *body2
